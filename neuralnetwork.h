...
const int MaxOffsetForB = 2;
const int MaxOffsetForSynapses = 2;
...
{
private:
	int numberOfNeuralNetworks = 0;
	int numberOfInputNeurons = 0;
	int numberOfLayers = 0;
	int numberOfLayerNeurons = 0;
	int numberOfEndNeurons = 0;
	int numberToReproduce = 2;
	int threadsCount;
